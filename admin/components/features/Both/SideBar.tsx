...
export const SideBar = () => {
  ...
  return (
    <main>
      <div className="flex flex-col gap-10 max-w-[302px] w-[280px] h-full bg-MainColor py-[26px] rounded-r-[30px]">
        ...
        <div className="flex flex-col gap-[26px]">
          <div className="flex flex-col gap-6">
            <div
              className={`${
                pathname === "/"
                  ? "border-slate-100 bg-slate-100 text-MainColor"
                  : " text-SecondColor border-MainColor  bg-MainColor"
