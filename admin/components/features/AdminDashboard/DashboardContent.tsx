      ...
      <div>
        ...
        <div className="pl-8 pt-8">
          <div className="w-full h-[800px]">
            <div className="py-5 px-6 bg-white border border-SecondColor rounded-t-xl ">
              <p className="text-[#121316] font-Inter text-[20px] font-bold leading-[28px] tracking-[-0.5px]">
                Admin dashboard
              </p>
            </div>
            <div className="flex justify-between border border-y-0 border-SecondColor">
            ...
            <div className="h-full w-full bg-white border border-SecondColor rounded-b-xl">
              <DashboardCard />
            </div>
          </div>
        </div>
